...
.login-card{
    ...
    background:#fff;
    box-shadow:
        0 24px 60px rgba(44,31,15,.18),
        0 4px 16px rgba(44,31,15,.08);
}
...
<div class="login-card">
    ...
    <div
        class="login-left relative flex flex-col items-center justify-center text-center overflow-hidden"
        ...
        <div class="relative z-10 flex flex-col items-center px-4 mt-2">
            ...
            <div class="w-[120px] h-[120px] bg-white rounded-[25px] shadow-[0_10px_20px_rgba(90,62,38,0.2)] flex items-center justify-center p-3 mb-6">
            ...
            <p class="text-[12.5px] leading-relaxed font-light max-w-[240px] mb-8 text-white drop-shadow-sm">
                Platform komunitas pecinta buku untuk berdiskusi, membaca bersama,
                dan mengikuti berbagai kegiatan literasi.
            </p>
    ...
    <div class="login-right flex flex-col justify-center bg-white">

        <div class="mb-6">
            <h1 class="text-[30px] font-bold tracking-tight mb-1 font-serif-custom" style="color:#3B2818;">
                Masuk Akun
            </h1>

            <p class="text-[11.5px] font-light" style="color:#8C7865;">
        ...
        <form action="{{ route('login.process') }}" method="POST" class="space-y-4">
            ...
            <div class="flex justify-between items-center text-[11.5px] pt-1">
                <label class="flex items-center gap-2 cursor-pointer select-none" style="color:#8C7865;">
                    <input
                        type="checkbox"
                        name="remember"
                        class="rounded w-3.5 h-3.5 checked:bg-[#8A6746]"
                        style="border-color:#DCD0C0;">
                    Ingat saya
                </label>
            </div>
            ...
            <button
                type="submit"
                class="w-full h-12 rounded-[14px] font-semibold text-white text-[15px] transition-all duration-300 hover:brightness-105 active:scale-[0.98] mt-2 shadow-[0_6px_15px_rgba(138,103,70,0.25)]"
