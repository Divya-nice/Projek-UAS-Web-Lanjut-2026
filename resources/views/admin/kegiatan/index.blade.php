...
<tr>
    ...
    <td>
        <a href="{{ route('kegiatan.edit',$item->id_kegiatan) }}" class="btn btn-warning btn-sm">
            <i class="bi bi-pencil-square"></i>
        </a>

        <form action="{{ route('kegiatan.destroy',$item->id_kegiatan) }}" method="POST" class="d-inline">
            @csrf
            @method('DELETE')
...
<tr>
    <td colspan="9">
        <div class="text-center py-5">
            ...
            <p class="text-muted">Silakan tambahkan kegiatan baru.</p>
            <a href="{{ route('kegiatan.create') }}" class="btn btn-brown">Tambah Kegiatan</a>
        </div>
    </td>
</tr>
@endforelse
